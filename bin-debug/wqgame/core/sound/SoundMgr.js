...
var SoundMgr = (function (_super) {
     ...
     * @param effectName
     */
    SoundMgr.prototype.playEffect = function (effectId) {
        if (!this.effectOn)
            return;
     ...
     * @param key
     */
    SoundMgr.prototype.playBg = function (bgName) {
        this.currBg = bgName;
        if (!this.bgOn)
            return;
        this.bg.play(bgName);
     ...
     * @returns {number}
     */
    SoundMgr.prototype.getBgVolume = function () {
     ...
     * @returns {number}
     */
    SoundMgr.prototype.getEffectVolume = function () {
