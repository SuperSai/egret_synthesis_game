...
var ControllerMgr = (function (_super) {
     ...
     * 清空处理
     */
    ControllerMgr.prototype.clear = function () {
        this._modules = {};
    };
    /**
     * 动态添加的Controller
     ...
     *
     */
    ControllerMgr.prototype.register = function (key, control) {
     ...
     *
     */
    ControllerMgr.prototype.unregister = function (key) {
        if (!this.isExists(key))
            return;
     ...
     *
     */
    ControllerMgr.prototype.isExists = function (key) {
     ...
     *
     */
    ControllerMgr.prototype.applyFunc = function (controllerD, key) {
        var param = [];
     ...
     * @returns {BaseModel}
     */
    ControllerMgr.prototype.getControllerModel = function (controllerD) {
        var manager = this._modules[controllerD];
        if (manager) {
