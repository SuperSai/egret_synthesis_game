 ...
 */
var RenderTextureMgr = (function (_super) {
    __extends(RenderTextureMgr, _super);
    /**
     * 构造函数
     */
    function RenderTextureMgr() {
     ...
     */
    RenderTextureMgr.prototype.pop = function () {
     ...
     * @param texture
     */
    RenderTextureMgr.prototype.push = function (texture) {
        var exists = false;
    ...
    return RenderTextureMgr;
}(BaseClass));
__reflect(RenderTextureMgr.prototype, "RenderTextureMgr");
//# sourceMappingURL=RenderTextureMgr.js.map