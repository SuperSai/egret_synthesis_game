 ...
 */
var LanguageMgr = (function (_super) {
    __extends(LanguageMgr, _super);
     ...
     * 初始化数据
     */
    LanguageMgr.prototype.setup = function (data) {
        var self = this;
    ...
    LanguageMgr.prototype.getLanguageMapData = function () {
        var self = this;
        return self._languageMap.getValues();
    };
    LanguageMgr.prototype.getLanguageById = function (key) {
        var self = this;
     ...
     */
    LanguageMgr.prototype.setModuleLanguage = function (node) {
        var self = this;
        if (!node || node && !node.numChildren || !LanguageMgr.isOpenLanguage)
            return;
        self.SearchAndModifyNodeLanguage(node);
    };
    LanguageMgr.prototype.SearchAndModifyNodeLanguage = function (node) {
     ...
     * @returns {string}
     */
    LanguageMgr.prototype.getLanguageText = function (key) {
        var arg = [];
    ...
    LanguageMgr.prototype.getTranslationWithArray = function (key, argsArr) {
        var self = this;
        if (self._languageMap.ContainsKey(key)) {
            return self.replaceStr(self._languageMap.TryGetValue(key), argsArr);
        }
    };
    LanguageMgr.prototype.languageReplace = function (str, args) {
        var self = this;
     ...
     * 根据正则表达式去替换内容
     */
    LanguageMgr.prototype.replaceStr = function (repContent, argsArr) {
        var self = this;
    ...
    LanguageMgr.isOpenLanguage = true;
    return LanguageMgr;
}(BaseClass));
